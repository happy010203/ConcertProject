        ...
        http
            ...
            .oauth2Login(oauth2Login -> oauth2Login
                .userInfoEndpoint(userInfo -> userInfo
                    .userService(customOAuth2UserService) // 使用自定義的 OAuth2UserService
                )
                .successHandler((request, response, authentication) -> {
                    ...
                    response.getWriter().write("{\"token\": \"" + token + "\", \"roles\": " + new ObjectMapper().writeValueAsString(roles) + ", \"name\": \"" + name + "\"}");
                })
            )
